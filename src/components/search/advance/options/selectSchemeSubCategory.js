...
const selectSchemeSubCategory = ({schemeSubcategory, setSchemeSubCategory}) => {
    return (
      <div className="input-container">
        ...
        <select
          ...
          name="fundHouse"
          required
          onChange={schemeSubcategory}
          value={setSchemeSubCategory}
        >
...
export default selectSchemeSubCategory